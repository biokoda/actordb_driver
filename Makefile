...
tool:
	gcc c_src/tool.c c_src/mdb.c c_src/midl.c c_src/lz4.c  -g  -DMDB_MAXKEYSIZE=0 -DSQLITE_DEFAULT_PAGE_SIZE=4096 -DSQLITE_DEFAULT_WAL_AUTOCHECKPOINT=0  -o adbtool
